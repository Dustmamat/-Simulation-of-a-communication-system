...
% 8X - 8QAM: 4 points on outer circle (axes), 4 points on inner circle 
R_outer_8x = 3; % Outer radius
R_inner_8x = 1.5; % Inner radius
constellation_points = [ ...
    R_outer_8x 0; 0 R_outer_8x; -R_outer_8x 0; 0 -R_outer_8x; ...
    R_inner_8x 0; 0 R_inner_8x; ...
    -R_inner_8x 0; 0 -R_inner_8x ... 
];
constellation_name = '8X - 8QAM';
