...
constellation_name = 'Square 8-QAM';
...
xlabel('In-Phase (I)');
ylabel('Quadrature (Q)');
legend('Constellation Points', 'Full Trajectory', 'Optimal Sampled Points', 'FontSize', 7);
max_val_noiseless = max(abs(constellation_points(:))) * 1.4; 
