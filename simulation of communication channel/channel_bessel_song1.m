...
freq_range = 1000:100:10000; % I used frequency range with big steps to reduce processing time but any step can be used.
...
text(best_cutoff/1000, 10*log10(best_SIR), sprintf('Peak at %.3f kHz', best_cutoff/1000), ...
